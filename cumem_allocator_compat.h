...
inline CUresult cuGetErrorString(CUresult hipError, const char** pStr) {
...
inline CUresult cuMemAddressReserve(CUdeviceptr* ptr, size_t size, size_t alignment,
                             CUdeviceptr addr, unsigned long long flags) {
  return hipMemAddressReserve(ptr, size, alignment, addr, flags);
}

inline CUresult cuMemCreate(CUmemGenericAllocationHandle* handle, size_t size,
...
inline CUresult cuMemMap(CUdeviceptr dptr, size_t size, size_t offset,
...
inline CUresult cuMemSetAccess(CUdeviceptr ptr, size_t size,
